    ...
    (chamado) => {
        form.value = chamado
            ? {
                  ...
                  data_coleta: chamado.data_coleta,
...
<template>
    <DialogRoot v-model:open="open">
        <DialogContent class="os-dialog">
            <DialogTitle class="os-heading">Editar Ordem de Serviço</DialogTitle>

            <div class="os-scroll">
            <div class="os-row2">
                <div>
                    <label class="os-label">Título *</label>
                    <input v-model="form.problema" class="os-field" />
                </div>
                <div>
            ...
            <div class="os-row2">
                ...
                <div>
                    ...
                    <input v-model="form.tecnico_nome" class="os-field" />
                </div>
            </div>
            ...
            <textarea v-model="form.laudo_tecnico" class="os-field os-textarea" />

            <div class="os-actions">
                <button type="button" class="os-btn os-btn-cancel" @click="open = false">Cancelar</button>
                <button type="button" class="os-btn os-btn-save" @click="updateChamado">Salvar Alterações</button>
            </div>
